...
<ImageBox src="/images/llms/tracing/langgraph-agent-trace.png" alt="LangGraph Tracing via autolog" />
...
When using LangGraph.js with OpenTelemetry-based tracing, you can combine the automatically generated traces with the [MLflow Tracing SDK](/genai/tracing) (`@mlflow/core`) to add custom spans, set tags, and update trace metadata within the same trace.
