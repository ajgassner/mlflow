...
import { Zap, FlaskConical, TestTube } from "lucide-react";

# Tracing Quickstart

:::tip MLflow Assistant
Need help setting up tracing? Try <ins>[MLflow Assistant](/genai/getting-started/try-assistant)</ins> - a powerful AI assistant that can add MLflow tracing to your project automatically.
:::
...
<TilesGrid>
  ...
  <TileCard
    icon={FlaskConical}
    title="Quality Test Traces"
    description="Run quality evaluations on your logged traces to ensure response accuracy"
