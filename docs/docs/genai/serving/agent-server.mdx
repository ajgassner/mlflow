---
title: MLflow Agent Server | MLflow AI Platform
description: Serve agents as production REST APIs with MLflow's FastAPI-based agent server. Automatic tracing, validation, and streaming support.
---
